...
// $sql = "SELECT id_technology FROM search_tech WHERE id_search = 1;";
...
// $sql = "SELECT alias, tech_name, level FROM developer d, technology t, developer_tech dt WHERE d.id_developer=dt.id_developer AND t.id_technology=dt.id_technology AND dt.id_technology IN (SELECT id_technology FROM search_tech WHERE id_search = 1);";
