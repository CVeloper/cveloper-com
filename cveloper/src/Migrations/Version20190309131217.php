 ...
 */
final class Version20190309131217 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE technology (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, logo VARCHAR(255) DEFAULT NULL, updated DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE developer (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, postal_code INT NOT NULL, city VARCHAR(255) NOT NULL, phone INT NOT NULL, github VARCHAR(255) DEFAULT NULL, linkedin VARCHAR(255) DEFAULT NULL, web VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, updated DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_65FB8B9A79F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dev_tech (id INT AUTO_INCREMENT NOT NULL, id_tech_id INT NOT NULL, id_developer_id INT NOT NULL, level INT NOT NULL, INDEX IDX_28CD4BA2BAEFD28C (id_tech_id), INDEX IDX_28CD4BA2471CE715 (id_developer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE experience (id INT AUTO_INCREMENT NOT NULL, id_developer_id INT NOT NULL, position VARCHAR(255) NOT NULL, company VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, date_from DATETIME NOT NULL, date_to DATETIME DEFAULT NULL, INDEX IDX_590C103471CE715 (id_developer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE training (id INT AUTO_INCREMENT NOT NULL, id_developer_id INT NOT NULL, degree VARCHAR(255) NOT NULL, institution VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, date_from DATETIME NOT NULL, date_to DATETIME DEFAULT NULL, INDEX IDX_D5128A8F471CE715 (id_developer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) DEFAULT NULL, id_github VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
